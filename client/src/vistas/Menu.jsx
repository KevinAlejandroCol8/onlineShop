    ...
    <>
      ...
      <div className="container-navbar">
        <nav className="navbar container">
          ...
          <ul className="menu">
            ...
            <li>
              <a onClick={() => navigate("/")}>Productos</a>
            </li>
            <li>
              <a>Descuentos</a>
            </li>
            ...
            <li>
              <a onClick={toggleMenu}>Mantenimientos</a>
            </li>
            <ul className={`submenu ${isOpen ? "open" : ""}`}>
              <li onClick={() => navigate("/descuentos")}>
                <a>Catalogo Descuentos</a>
              </li>
              <li onClick={() => navigate("/tipoProductos")}>
                <a>Catalogo Productos</a>
              </li>
              <li onClick={() => navigate("/ingresoProduct")}>
                <a>Productos</a>
              </li>
              <li onClick={() => navigate("/EmpleadosList")}>
                <a>Empleados</a>
              </li>
            </ul>
          </ul>
      ...
      >
        <div className={styles.container}>
          {/* Contenido de tu modal de inicio de sesión */}
          <div className="container" id="container">
            <div className="form-container sign-in-container">
              <form className="formLogin">
                <h1>Iniciar sesión</h1>
                <span>usa tu cuenta</span>
                <input className="inputLogin" type="email" placeholder="NickName" />
                <input className="inputLogin" type="password" placeholder="Password" />
                <a>¿Olvidaste tu contraseña?</a>
                <button className="buttonsLogin" onClick={closeModal}>Cerrar Modal</button>
              </form>
            </div>
              ...
              <div className="overlay">
                <div className="overlay-panel overlay-right">
                  ...
                  <div className="button-container">
                    ...
                    <button className="ghost buttonsLogin">Registrar</button>
                  </div>
                </div>
              </div>
            </div>
          </div>
          {/* Agrega aquí los campos y botones de inicio de sesión */}
